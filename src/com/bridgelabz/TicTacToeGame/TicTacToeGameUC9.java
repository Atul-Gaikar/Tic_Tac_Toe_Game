...
public class TicTacToeGameUC9 {
	...
	private TicTacToeGameUC9(char[] board) {
		this.board = board;
	}

	public TicTacToeGameUC9 getCopy() {
		return new TicTacToeGameUC9(this.board);
	}
	...
	public int nextWinnigMovePosition(char[] board, char character) {
		TicTacToeGameUC9 temp = this.getCopy();
	...
	public static void main(String[] args) {
		TicTacToeGameUC9 game = new TicTacToeGameUC9();
