...
public class TicTacToeGameUC10 {
	...
	private TicTacToeGameUC10(char[] board) {
		this.board = board;
		this.moveCount = 0;
	}

	public TicTacToeGameUC10 getCopy() {
		return new TicTacToeGameUC10(this.board);
	}
	...
	public int nextWinnigMovePosition(char[] board, char character) {
		TicTacToeGameUC10 temp = this.getCopy();
	...
	public static void main(String[] args) {
		TicTacToeGameUC10 game = new TicTacToeGameUC10();
